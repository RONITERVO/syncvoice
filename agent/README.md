...
Gemini output-transcription fragments are not treated as word timestamps. Published character cues use deterministic full-duration word pacing so highlighting cannot finish before the audio. Existing generated libraries can be repaired without touching audio:
